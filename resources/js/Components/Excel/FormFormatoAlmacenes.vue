  ...
  <FormSection @submitted="$emit('submit')">
    ...
    <template #form>
      ...
      <div v-if="form.almacen_id !== ''" class="col-span-6 sm:col-span-6">
        ...
        <div v-else-if="almacenes.find(isOwner).empresa === null" class="col-span-6 sm:col-span-6">
          <InputLabel for="persona_id" value="Nombre de persona inspeccionada"/>
          <select name="persona_id" id="persona_id" v-model:="form.persona_id" class="mt-1 block w-full">
      ...
      <div v-if="form.almacen_id !== ''" class="col-span-6 sm:col-span-6">
        ...
        <select name="producto_id" id="producto_id" v-model:="form.producto_id" class="mt-1 block w-full">
          <option v-for="producto in almacenes.find(isOwner).productos" :value="producto.id">{{ producto.nombre }}
          </option>
        </select>
      </div>
      <div class="col-span-6 sm:col-span-6">
      ...
      <div class="col-span-6 sm:col-span-6">
        ...
        <TextInput id="fitosanitario" type="checkbox" checked v-model:="form.fitosanitario"
          class="w-10 h-5 mt-1"/>
      </div>
      <div class="col-span-6 sm:col-span-6">

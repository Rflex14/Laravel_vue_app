...
const Descargar = (archivo) => {
  const url = route('descarga.respaldoAlmacenes', { file: archivo });
...
<template>
  <AppLayout title="Respaldos">
    <template #header>
      <h1 class="font-semibold text-xl -text-gray-800 leading-tight">Respaldos formato de almacenes</h1>
    </template>
